...
export const metadata = {
  title: "Escorts en Centro | Montevideo | VIAVIP",
  description:
    "Descubrí escorts en Centro, Montevideo, con perfiles verificados y contacto directo en VIAVIP.",
};

export default async function EscortsCentroPage({
  searchParams,
}: {
  ...
  const { items, count, error } = await fetchPublicaciones(cat, filtros, { departamento: "Montevideo", zona: "Centro" });
  ...
  return (
    <main>
      ...
      <TrustBlock />
      <DestacadasDiamante categoria={cat} zona="centro" />
      <div style={{ padding: "20px 16px 0" }}>
        <h1
          className="vv-section-title"
          style={{ fontSize: "24px", margin: 0 }}
        >
          Escorts VIP en Centro
        </h1>
      ...
      <ListadoFiltered
        ...
        queryContext={{ categoria: cat, extra_dep: "Montevideo", extra_zona: "Centro" }}
      />
    </main>
  );
}
