...
export const metadata = {
  title: "Escorts verificadas en Uruguay | Perfiles reales | VIAVIP",
  description:
    "Encuentra escorts verificadas en Uruguay con perfiles 100% auténticos. Acompañantes con identidad confirmada.",
};

export default async function EscortsVerificadasPage({
  searchParams,
}: {
