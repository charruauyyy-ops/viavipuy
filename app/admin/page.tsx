...
const navCards = [
  ...
  {
    title: "Denuncias",
    description: "Bloquear y gestionar perfiles denunciados",
  ...
  {
    title: "Pagos",
    description: "Aprobar y gestionar pagos de planes",
    href: "/admin/pagos",
    icon: (
      <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    title: "Precios",
    description: "Administrar precios de publicaciones y planes",
    href: "/admin/precios",
    icon: (
      <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    description: "Inbox de alertas y avisos del sistema",
