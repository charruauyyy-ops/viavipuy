    ...
    async function loadData() {
      try {
        ...
        const [
          ...
          getSum("pagos_viavip", { gte: hoy, eq: ["estado_pago", "acreditado"] }), getSum("pagos_viavip", { gte: sieteDias, eq: ["estado_pago", "acreditado"] }), getSum("pagos_viavip", { gte: treintaDias, eq: ["estado_pago", "acreditado"] }), getSum("pagos_viavip", { eq: ["estado_pago", "acreditado"] }),
